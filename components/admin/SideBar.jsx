              ...
              <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                ...
                <li>
                  ...
                  <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                    <li className="w-100">
                      <Link href="http://localhost:3000/admin/datakue">
                        <a className="nav-link px-0">
                          {""}
                          <span className="d-none d-sm-inline">DATA KUE</span>
                          {""}
                        </a>
                      </Link>
                    </li>
                    <li>
                      <a href="http://localhost:3000/admin/createkue" className="nav-link px-0">
                        {" "}
                        <span className="d-none d-sm-inline">Tambah Toping</span>
                      </a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                    <i className="fs-4 bi-table" /> <span className="ms-1 d-none d-sm-inline">Orders</span>
                  </a>
                </li>
                <li>
                  <a href="#submenu2" data-bs-toggle="collapse" className="nav-link px-0 align-middle ">
                    <i className="fs-4 bi-bootstrap" /> <span className="ms-1 d-none d-sm-inline">Bootstrap</span>
                  </a>
